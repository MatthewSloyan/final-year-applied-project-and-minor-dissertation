...
public class Client : MonoBehaviour
{
    ...
    [Header("Network")]
    public string ipAddress = "192.168.1.9";
    ...
    protected void StartClient()
    {
        ...
        try
        {
            ...
            SendMessageToServer("what time are you open?");
        }
    ...
    protected void SendMessageToServer(string sendMsg)
    {
        ...
        sendMsg = "what time are you open?";

        //Build message to server
        byte[] msg = Encoding.UTF8.GetBytes(sendMsg); //Encode message as bytes
                                                        //Start Sync Writing
    ...
    private void MessageReceived(IAsyncResult result)
    {
        if (result.IsCompleted && m_Client.Connected)
        {
            ...
            Debug.Log("DATA RECIEVED: " + m_ReceivedMessage);
        }
    }
    #endregion
