...
public class SpeechRecognition : MonoBehaviour
{
    ...
    private string SpeechServiceAPIKey = "a2f75e30125b4f099012eaa7f9a5c840";

    private string SpeechServiceRegion = "westeurope";
    ...
    private void Start()
    {
        ...
        micPermissionGranted = true;
         ...
         tmp = TextMeshObj.GetComponent<TextMeshProUGUI>();
...
#region Speech Recognition event handlers
    ...
    void Update()
    {
        ...
        lock (threadLocker)
        {
            ...
            tmp.text = recognizedString;
            //TextMeshObj.GetComponent<TextMeshPro>().text = recognizedString;
