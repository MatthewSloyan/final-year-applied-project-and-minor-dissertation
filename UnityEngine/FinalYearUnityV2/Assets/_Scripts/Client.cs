...
public class Client : MonoBehaviour
{
    ...
    IEnumerator GetText()
    {
        ...
        UnityWebRequest www = UnityWebRequest.Post("https://aaronchannon1.pythonanywhere.com/request", form);
        ...
        else
        {
            ...
            try
            {
                ...
                new ScoreManager(sessionId, int.Parse(reponses[1]), userInput, reponses[0]).UpdateScore();
            }
            catch
            { 
