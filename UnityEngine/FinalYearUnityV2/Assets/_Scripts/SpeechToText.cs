...
public class SpeechToText : MonoBehaviour
{
    ...
    public async void convertSpeechToText(int id, int persona, string voice)
    {
        ...
        if (micPermissionGranted && isPersonActive)
        {
            ...
            var config = SpeechConfig.FromSubscription("698bedad9cae4eecbc88738a19c4d03c", "westeurope");
    ...
    void Start()
    {
        ...
        //SpeechToText.Instance.convertSpeechToText();
        //Debug.Log("HERE");
    }
    ...
    void Update()
    {
        ...
        lock (threadLocker)
        {
            if (outputText != null)
            {
                ...
                TextMeshProUGUI tm = GameObject.Find("Text (TMP)").gameObject.GetComponent<TextMeshProUGUI>();
                tm.text = message;
                finished = true;
            }
        }
